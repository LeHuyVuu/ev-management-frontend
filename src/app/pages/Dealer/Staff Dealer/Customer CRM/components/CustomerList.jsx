    ...
    return (
        <div className="p-4 border rounded-lg shadow-sm bg-white w-full max-w-sm">
            ...
            <div className="flex justify-between items-center mb-3">
                ...
                <button className="bg-blue-600 text-white text-sm px-3 py-1.5 rounded-lg hover:bg-blue-700">
                    + Thêm Mới
                </button>
            </div>
            ...
            <div className="divide-y border-t">
                {customers.map((c) => (
                    <div
                        ...
                        className={`grid grid-cols-3 items-center px-2 py-5 cursor-pointer ${selectedId === c.id ? "bg-blue-50" : "hover:bg-gray-50"
                            }`}
                    >
