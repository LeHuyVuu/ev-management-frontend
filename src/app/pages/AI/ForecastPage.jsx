...
// // Lấy trạng thái toggle từ localStorage (giữ sau F5)
// function getInitialUseDomain() {
//   try {
//     const v = localStorage.getItem("debugall.useDomain");
//     return v === "1";
//   } catch {
//     return false;
//   }
...
// // (Tuỳ chọn) Clear Service Worker + caches để tránh dính bundle cũ
...
//     }
//     // Chỉ log cho biết
//     console.log("[debug-all] service workers & caches cleared");
//   } catch (e) {
//     console.warn("[debug-all] cannot clear SW/caches:", e);
//   }
// }
...
// // Ghép URL tuyệt đối từ BASE + path + query
// function abs(BASE, path, queryObj) {
...
// // Gọi API debug-all
// async function getDebugAllInline(BASE, params = {}) {
//   const url = abs(BASE, "/utility-service/api/forecast/debug-all", {
//     page: String(params.page ?? 1),
//     pageSize: String(params.pageSize ?? 20),
//     horizon: String(params.horizon ?? 8),
//     dealerId: params.dealerId ? String(params.dealerId) : undefined,
//     vehicleVersionId: params.vehicleVersionId ? String(params.vehicleVersionId) : undefined,
//     search:
//       params.search && String(params.search).trim().length > 0
...
// // Lặp trang để lấy danh sách options Dealers / Versions
// async function fetchAllPagesInline(baseUrl) {
//   const items = [];
//   let pageNumber = 1;
//   while (true) {
...
//   // Toggle Base URL (Domain / Localhost)
...
//   // Toggle handler: lưu trạng thái + clear SW/caches + reload
//   const onToggleBase = async (checked) => {
//     setUseDomain(checked);
//     try {
//       localStorage.setItem("debugall.useDomain", checked ? "1" : "0");
//     } catch {}
//     await nukeSwAndCaches();
//     // nạp lại options và dữ liệu theo BASE mới
//     loadOptions(checked ? "https://prn232.freeddns.org" : "https://localhost:7050");
//     loadData(1, checked ? "https://prn232.freeddns.org" : "https://localhost:7050");
//   };
...
//       const dealers = await fetchAllPagesInline(`${base}/dealer-service/api/Dealers`);
//       setDealerOptions(
//         (dealers || []).map((d) => ({
//           value: d.dealerId,
...
//       );
//     } catch (e) {
//       setOptError((prev) => prev || e.message || "Lỗi tải danh sách Dealer");
//     } finally {
//       setLoadingDealerOpt(false);
//     }

//     try {
//       setLoadingVersionOpt(true);
//       const versions = await fetchAllPagesInline(`${base}/brand-service/api/vehicle-versions`);
//       setVersionOptions(
//         (versions || []).map((v) => ({
...
//       );
//     } catch (e) {
//       setOptError((prev) => prev || e.message || "Lỗi tải danh sách Version");
//     } finally {
//       setLoadingVersionOpt(false);
//     }
//   }

//   useEffect(() => {
//     // lần đầu mount hoặc khi BASE thay đổi
//     loadOptions();
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [BASE]);

//   // ===== Load debug-all data =====
//   async function loadData(p = 1, baseOverride) {
//     const base = baseOverride || BASE;
//     try {
//       setLoading(true);
//       setErr("");

//       const resp = await getDebugAllInline(base, {
//         page: p,
//         pageSize,
...
//                 {/* Toggle Base URL ngay trong bộ lọc */}
//                 <Col xs={24} md={12} lg={6}>
...
//                   value={`${page}/${Math.max(1, Math.ceil(totalPairs / pageSize))}`}
//                 />
//               </Card>
//             </Col>
//             <Col xs={24} md={12} lg={8}>
