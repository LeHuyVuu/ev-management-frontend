...
import { 
  ...
  UserCog,
  Shield,
  LayoutDashboard, // 👈 icon mới cho Staff Control
} from 'lucide-react';
...
const menuItems = [
  {
    ...
    children: [
      ...
      { label: 'EV Models', icon: <Package className="w-4 h-4" /> },
      { label: 'Dealer Inventory', icon: <Users className="w-4 h-4" /> },
      { label: 'Distribution Orders', icon: <FileText className="w-4 h-4" /> },
    ]
  },
  {
    id: 'products',
